...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (currentItem["isCompleted"] as? Bool) == true {
            cell.imageView?.image = UIImage(named: "done.imageset")
        } else {
            cell.imageView?.image = UIImage(named: "nedone.imageset")
        }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if changeState(at: indexPath.row) {
            tableView.cellForRow(at: indexPath)?.imageView?.image = UIImage(named: "done.imageset")
        } else {
            tableView.cellForRow(at: indexPath)?.imageView?.image = UIImage(named: "nedone.imageset")
        }
